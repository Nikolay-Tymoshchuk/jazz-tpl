(function (h, e) {
  ...
  var r = (function (a, b) {
    ...
    c.Tween.prototype = {
      ...
      start: function (a) {
        ...
        this._onStartCallbackFired = !1;
        this._startTime =
          void 0 !== a ? ('string' === typeof a ? c.now() + parseFloat(a) : a) : c.now();
    ...
    c.Interpolation = {
      ...
      Bezier: function (a, b) {
        for (
          var d = 0, g = a.length - 1, e = Math.pow, l = c.Interpolation.Utils.Bernstein, h = 0;
          h <= g;
          h++
        )
  ...
  z.prototype = Object.assign(Object.create(e.Sprite.prototype), {
    ...
    removeHoverElement: function () {
      this.element &&
        (this.element.left &&
          (this.container.removeChild(this.element.left), (this.element.left = null)),
        this.element.right &&
          (this.container.removeChild(this.element.right), (this.element.right = null)),
  ...
  I.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
      ...
      return [
        {
          title: 'Control',
          subMenu: [
            { title: this.TOUCH_ENABLED ? 'Touch' : 'Mouse', handler: b('enableControl', E.ORBIT) },
    ...
    createVideoControlSeekbar: function () {
      ...
      function b(a) {
        e &&
          ((l =
            ((a.clientX || (a.changedTouches && a.changedTouches[0].clientX)) - p) / f.clientWidth),
          (l = m + l),
          (l = 1 < l ? 1 : 0 > l ? 0 : l),
          f.setProgress(l),
          g.dispatchEvent({
          ...
          if (a.target !== q) {
            var b =
              a.changedTouches && 0 < a.changedTouches.length
                ? (a.changedTouches[0].pageX - a.target.getBoundingClientRect().left) /
                  this.clientWidth
    ...
    createMenu: function () {
      ...
      c.visibility = 'hidden';
      c.opacity = 0;
      c.boxShadow = '0 0 12pt rgba(0,0,0,0)';
      c.borderRadius = '2px';
      c.overflow = 'hidden';
  ...
  B.prototype = Object.assign(Object.create(n.prototype), {
    ...
    setVideoCurrentTime: function (a) {
      ...
      b &&
        ...
        this.dispatchEvent({ type: 'panolens-viewer-handler', method: 'onVideoUpdate', data: a }));
    },
    playVideo: function () {
      var a = this.videoElement,
  ...
  C.prototype = Object.assign(Object.create(y.prototype), {
    ...
    registerMouseEvents: function () {
      this.container.addEventListener('mousedown', this.onMouseDown.bind(this), { passive: !0 });
      this.container.addEventListener('mousemove', this.onMouseMove.bind(this), { passive: !0 });
      this.container.addEventListener('mouseup', this.onMouseUp.bind(this), { passive: !0 });
      this.container.addEventListener('touchstart', this.onMouseDown.bind(this), { passive: !0 });
      this.container.addEventListener('touchmove', this.onMouseMove.bind(this), { passive: !0 });
      this.container.addEventListener('touchend', this.onMouseUp.bind(this), { passive: !0 });
      this.container.addEventListener('mousewheel', this.onMouseWheel.bind(this), { passive: !1 });
  ...
  da.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
    ...
    add: function (a) {
      ...
      this.scene.add(a);
      a.addEventListener &&
        a.addEventListener('panolens-viewer-handler', this.eventHandler.bind(this));
      a instanceof n &&
        a.dispatchEvent &&
      ...
      'panorama' === a.type &&
        (this.addPanoramaEventListener(a), this.panorama || this.setPanorama(a));
    },
    remove: function (a) {
      a.removeEventListener &&
        a.removeEventListener('panolens-viewer-handler', this.eventHandler.bind(this));
      this.scene.remove(a);
    },
    ...
    onWindowResize: function (a, b) {
      var c =
        this.container.classList.contains('panolens-container') || this.container.isFullscreen;
        ...
        if (
          ...
          (a =
            a.changedTouches && 1 === a.changedTouches.length
              ? this.onTap(
                  { clientX: a.changedTouches[0].clientX, clientY: a.changedTouches[0].clientY },
                  b,
                )
              : this.onTap(a, b)),
    ...
    onTap: function (a, b) {
      ...
      if (this.panorama) {
        (('mousedown' !== a.type && this.touchSupported) || this.OUTPUT_INFOSPOT) &&
          this.outputPosition();
        ...
        if ('click' === b)
          ...
          if (
            ...
            this.hoverObject.dispatchEvent &&
              (this.hoverObject.dispatchEvent({ type: 'hoverleave', mouseEvent: a }),
              this.reticle.end()),
          ...
          d &&
            ...
            (this.hoverObject !== d &&
              ((this.hoverObject = d),
              this.hoverObject.dispatchEvent &&
                (this.hoverObject.dispatchEvent({ type: 'hoverenter', mouseEvent: a }),
            ...
            'mousedown' === this.userMouse.type &&
              ...
              ((this.pressEntityObject = d),
              this.pressEntityObject.dispatchEvent &&
                this.pressEntityObject.dispatchEvent({ type: 'pressstart-entity', mouseEvent: a })),
            'mousedown' === this.userMouse.type &&
              this.pressObject != e &&
              ((this.pressObject = e),
              this.pressObject.dispatchEvent &&
                this.pressObject.dispatchEvent({ type: 'pressstart', mouseEvent: a })),
            ...
            this.pressEntityObject &&
              this.pressEntityObject.dispatchEvent &&
              this.pressEntityObject.dispatchEvent({ type: 'pressmove-entity', mouseEvent: a }),
            this.pressObject &&
              this.pressObject.dispatchEvent &&
          ...
          !d &&
            this.pressEntityObject &&
            this.pressEntityObject.dispatchEvent &&
            (this.pressEntityObject.dispatchEvent({ type: 'pressstop-entity', mouseEvent: a }),
            (this.pressEntityObject = void 0));
          !e &&
            this.pressObject &&
            this.pressObject.dispatchEvent &&
  ...
  '105' != e.REVISION &&
    console.warn('three.js version is not matched. Please consider use the target revision 105');
  window.TWEEN = r;
  h.BasicPanorama = O;
  h.CONTROLS = E;
  h.CameraPanorama = J;
